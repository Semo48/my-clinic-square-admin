...
export async function GET(request: NextRequest) {
      ...
      try {
        const apiResponse = await fetch(`${SERVER_URL}/${actor}?page=${page}&limit=${limit}&state=${state}&fields=name,specialization,profilePic,address,email,phoneNumbers,about,gender,license,dateOfBirth,role,state`, {
          headers: {
