...
export async function GET(request: NextRequest) {
      ...
      try {
        const apiResponse = await fetch(`${SERVER_URL}/patient?page=${page}&limit=${limit}&fields=name,specialization,profilePic,address,email,phoneNumbers,about,gender,license,dateOfBirth&keyword=${keyword}`, {
          headers: {
